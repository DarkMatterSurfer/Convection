...
for i in range(len(listRa)):
    ...
    try: 
        np.savetxt('/home/iiw7750/Convection/eigenvalprob_plots/marginalstabilityconditions/dataraw/'+csvfile, np.column_stack((arr_x,z, b,p,ux,uz)), delimiter=",", fmt='%s', header=header)
    except Exception as e:
        np.savetxt('/home/brogers/Convection/eigenvalprob_plots/marginalstabilityconditions/dataraw/'+csvfile, np.column_stack((arr_x,z, b,p,ux,uz)), delimiter=",", fmt='%s', header=header)
    #Heat map plotting
    ...
    plt.close()
    try:
        widthfinder('/home/iiw7750/Convection/eigenvalprob_plots/marginalstabilityconditions/dataraw/'+csvfile)
    except:
        widthfinder('/home/brogers/Convection/eigenvalprob_plots/marginalstabilityconditions/dataraw/'+csvfile)